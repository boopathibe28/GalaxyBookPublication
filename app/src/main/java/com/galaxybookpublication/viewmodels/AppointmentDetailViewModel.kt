...
import com.galaxybookpublication.models.data.response.PaymentAppointmentResponse
...
class AppointmentDetailViewModel : ViewModel() {
    ...
    private var  _appointmentPostLiveData = MutableLiveData<PaymentAppointmentResponse>()
    var appointmentPostLiveData: LiveData<PaymentAppointmentResponse> =
        _appointmentPostLiveData
    ...
    fun postSubmitOrder(
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                val response = apiInterface.postOrderPayment(
                    orderId,
                    appointmentId,
                    amount,
                    paidAt,
                ...
                if (response.isSuccessful) {
                    _appointmentPostLiveData.postValue(response.body())
                } else {
